...
const ChoosePlanScreen: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        Select the best plan for your business needs. You can upgrade or
        downgrade anytime.
      </BodyText>
      {plans.map((plan) => {
        ...
        return (
          ...
          >
            ...
            <BodyText size="small" color="tertiary" style={{ marginBottom: 8 }}>
              {plan.price}
            </BodyText>
            {plan.features.map((feature, idx) => (
              <BodyText key={idx} size="small" color="secondary">
                • {feature}
              </BodyText>
            ))}
            <TouchableOpacity
