...
exports.syncRevenueCatSubscription = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        if (!revenueCatApiKey) {
            throw new https_1.HttpsError('internal', 'RevenueCat API key not configured');
        }
        try {
            ...
            if (response.ok) {
                ...
                if (subscriber === null || subscriber === void 0 ? void 0 : subscriber.subscriptions) {
            ...
            throw new https_1.HttpsError('internal', 'Failed to check RevenueCat subscription');
        }
        if (existingCustomerInfo) {
            ...
            const subscriptionDoc = {
                ...
                limits: ((_b = subscriptionTiers[existingCustomerInfo.tier]) === null || _b === void 0 ? void 0 : _b.limits) || subscriptionTiers.starter.limits,
                features: ((_c = subscriptionTiers[existingCustomerInfo.tier]) === null || _c === void 0 ? void 0 : _c.features) || subscriptionTiers.starter.features,
                history: [{
                        tier: existingCustomerInfo.tier,
            ...
            if (!existingUsage.exists) {
                const usageDoc = {
                    ...
                    apiCalls: 0,
                    reportsGenerated: 0,
                    limits: ((_d = subscriptionTiers[existingCustomerInfo.tier]) === null || _d === void 0 ? void 0 : _d.limits) || subscriptionTiers.starter.limits,
            ...
            return {
                ...
                tier: existingCustomerInfo.tier,
                productId: existingCustomerInfo.productId,
                expiresAt: ((_e = existingCustomerInfo.expiresAt) === null || _e === void 0 ? void 0 : _e.toISOString()) || null
            };
        }
        else {
        ...
        Logger.error('Error in syncRevenueCatSubscription', {
            error: error.message,
            userId: (_f = request.auth) === null || _f === void 0 ? void 0 : _f.uid
        });
        if (error instanceof https_1.HttpsError) {
            throw error;
        }
        throw new https_1.HttpsError('internal', 'Failed to sync subscription');
    }
});
        ...
        try {
            ...
            if (existingCustomerInfo) {
                ...
                const subscriptionDoc = {
                    ...
                    limits: ((_a = subscriptionTiers[existingCustomerInfo.tier]) === null || _a === void 0 ? void 0 : _a.limits) || subscriptionTiers.starter.limits,
                    features: ((_b = subscriptionTiers[existingCustomerInfo.tier]) === null || _b === void 0 ? void 0 : _b.features) || subscriptionTiers.starter.features,
                    history: [{
                            tier: existingCustomerInfo.tier,
                            startDate: existingCustomerInfo.originalPurchaseDate || new Date(),
                            endDate: null,
                ...
                const usageDoc = {
                    ...
                    apiCalls: 0,
                    reportsGenerated: 0,
                    limits: ((_c = subscriptionTiers[existingCustomerInfo.tier]) === null || _c === void 0 ? void 0 : _c.limits) || subscriptionTiers.starter.limits,
                    resetDate: `${new Date().getFullYear()}-${String(new Date().getMonth() + 1).padStart(2, '0')}-01`,
                    createdAt: now,
                    updatedAt: now,
                };
